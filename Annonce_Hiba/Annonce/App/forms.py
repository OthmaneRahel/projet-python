...
class InscriptionForm(UserCreationForm):
    ...
    def save(self, commit=True):
        ...
        if commit:
            user.image = 'https://static.vecteezy.com/system/resources/previews/008/442/086/non_2x/illustration-of-human-icon-user-symbol-icon-modern-design-on-blank-background-free-vector.jpg'
            user.save()
        return user
...
class ModifierAnnonceForm(forms.ModelForm):
    class Meta:
        model = Annonce
        fields = ['titre', 'description', 'prix', 'localisation','statut', 'categorie', 'isPremieum']
